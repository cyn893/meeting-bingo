...
graph TB
    ...
    subgraph Vercel["VERCEL EDGE NETWORK<br/>Static Hosting, CDN, SSL"]
        Domain["meetingbingo.vercel.app"]
    end
...
graph TB
    ...
    MP --> A["Option A: WebSocket Server<br/><i>Requires Backend</i>"]
    MP --> B["Option B: Peer-to-Peer<br/><i>WebRTC</i>"]
    MP --> C["Option C: Firebase<br/><i>Realtime Database</i>"]
